...
// AI Agent Events - ERC-8004 Agent System (policy lifecycle)
...
// Agent execution events (user-funded) - commented out for investigation
...
// PricePrediction Events - commented out: Claimed crashes when start block skips Predicted events
// (root cause of agent 1431 not being indexed: crash at block 38575101 blocked all subsequent blocks)
...
console.log("🤖 Investigating: AI Agent policy lifecycle events only (POLICY_INSTALLED, STRATEGY_AGENT_AUTHORIZED, etc.)");
